                ...
                <div className="container">
                    <div className="app-download-inner">
                                ...
                                <div className="app-download-content">
                                    ...
                                    <div className="btn-box">
                                        <a href="https://play.google.com/store/apps" className="playstore-btn" target="_blank">
                                            <LazyLoadImage src="images/play-store.png" alt="image" />
                                            Get It On
                                            <span>Google Play</span>
                                        </a>
                                        <a href="https://www.apple.com/app-store/" className="applestore-btn" target="_blank">
                                            <LazyLoadImage src="images/apple-store.png" alt="image" />
                                            Download on the
                            ...
                            <div className="col-lg-6 col-md-12">
                                <div className="app-download-image">
                                    <ScrollAnimation animateIn="fadeInUp">
                                        <LazyLoadImage src="images/app/app-img3.png" alt="app-img" />
                                    </ScrollAnimation>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="shape5">
                            <LazyLoadImage src="images/shape/shape4.png" alt="shape4" />
                        </div>
